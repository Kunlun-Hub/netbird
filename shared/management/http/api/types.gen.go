...
// Defines values for AccountLicenseLicense.
const (
	AccountLicenseLicenseEnterprise AccountLicenseLicense = "enterprise"
	AccountLicenseLicenseTry        AccountLicenseLicense = "try"
	AccountLicenseLicenseYear       AccountLicenseLicense = "year"
)

// Valid indicates whether the value is a known member of the AccountLicenseLicense enum.
func (e AccountLicenseLicense) Valid() bool {
	switch e {
	case AccountLicenseLicenseEnterprise:
		return true
	case AccountLicenseLicenseTry:
		return true
	case AccountLicenseLicenseYear:
		return true
	default:
		return false
	}
...
// Defines values for AccountLicensePlan.
const (
	AccountLicensePlanBasic AccountLicensePlan = "basic"
	AccountLicensePlanPro   AccountLicensePlan = "pro"
)

// Valid indicates whether the value is a known member of the AccountLicensePlan enum.
func (e AccountLicensePlan) Valid() bool {
	switch e {
	case AccountLicensePlanBasic:
		return true
	case AccountLicensePlanPro:
		return true
	default:
		return false
	}
...
// Defines values for AccountLicenseStatus.
const (
	AccountLicenseStatusActive      AccountLicenseStatus = "active"
	AccountLicenseStatusExpired     AccountLicenseStatus = "expired"
	AccountLicenseStatusInvalid     AccountLicenseStatus = "invalid"
	AccountLicenseStatusNotStarted  AccountLicenseStatus = "not_started"
	AccountLicenseStatusUnlicensed  AccountLicenseStatus = "unlicensed"
	AccountLicenseStatusUrlMismatch AccountLicenseStatus = "url_mismatch"
)

// Valid indicates whether the value is a known member of the AccountLicenseStatus enum.
func (e AccountLicenseStatus) Valid() bool {
	switch e {
	case AccountLicenseStatusActive:
		return true
	case AccountLicenseStatusExpired:
		return true
	case AccountLicenseStatusInvalid:
		return true
	case AccountLicenseStatusNotStarted:
		return true
	case AccountLicenseStatusUnlicensed:
		return true
	case AccountLicenseStatusUrlMismatch:
		return true
	default:
		return false
	}
...
type AccountLicense struct {
	...
	// License License types included in the installed key.
	License []AccountLicenseLicense `json:"license"`

	// LicenseKeyMasked Masked installed license key.
	...
	// StartTime License validity start date.
	StartTime *time.Time `json:"start_time,omitempty"`

	// Status Current license status.
	Status AccountLicenseStatus `json:"status"`
...
type AccountLicenseLicense string

// AccountLicensePlan Effective entitlement plan.
type AccountLicensePlan string

// AccountLicenseStatus Current license status.
type AccountLicenseStatus string
...
// PutApiAccountsAccountIdLicenseJSONRequestBody defines body for PutApiAccountsAccountIdLicense for application/json ContentType.
type PutApiAccountsAccountIdLicenseJSONRequestBody = UpdateAccountLicenseRequest
