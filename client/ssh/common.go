...
const (
	NetBirdSSHConfigFile = "99-cloink.conf"
...
// DaemonHostKeyVerifier implements HostKeyVerifier using the Cloink daemon
...
// VerifySSHHostKey verifies an SSH host key by querying the Cloink daemon
