...
type FlowFields struct {
	...
	// DNS query/response information when this flow carries DNS traffic.
	DnsInfo *DNSInfo `protobuf:"bytes,16,opt,name=dns_info,json=dnsInfo,proto3" json:"dns_info,omitempty"`
}
...
func (x *FlowFields) GetDnsInfo() *DNSInfo {
	if x != nil {
		return x.DnsInfo
	}
	return nil
...
func (x *DNSInfo) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *DNSInfo) GetQueryType() string {
	if x != nil {
		return x.QueryType
	}
	return ""
...
func (x *DNSInfo) GetAnswers() []string {
	if x != nil {
		return x.Answers
	}
	return nil
...
func (x *DNSInfo) GetRcode() string {
	if x != nil {
		return x.Rcode
	}
	return ""
...
var file_flow_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x69, 0x61, 0x74, 0x6f, 0x72, 0x22, 0xc6, 0x04, 0x0a, 0x0a, 0x46, 0x6c, 0x6f, 0x77,
	...
	,
...
var file_flow_proto_goTypes = []interface{}{
	...
	(*DNSInfo)(nil),               // 5: flow.DNSInfo
	(*PortInfo)(nil),              // 6: flow.PortInfo
	(*ICMPInfo)(nil),              // 7: flow.ICMPInfo
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_flow_proto_depIdxs = []int32{
	8, // 0: flow.FlowEvent.timestamp:type_name -> google.protobuf.Timestamp
	...
	6, // 4: flow.FlowFields.port_info:type_name -> flow.PortInfo
	7, // 5: flow.FlowFields.icmp_info:type_name -> flow.ICMPInfo
	5, // 6: flow.FlowFields.dns_info:type_name -> flow.DNSInfo
	2, // 7: flow.FlowService.Events:input_type -> flow.FlowEvent
	3, // 8: flow.FlowService.Events:output_type -> flow.FlowEventAck
